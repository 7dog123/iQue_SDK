...
if id | grep "^uid=0(root)" > /dev/null; then
	...
	make CC=mips-linux-gnu-gcc-10 CFLAGS="-I /usr/src/linux-headers-5.4.0-77-generic/include/config -I /usr/src/linux-headers-5.4.0-77-generic/include/config/dm" -C modules install
