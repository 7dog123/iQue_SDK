...
if id | grep "^uid=0(root)" > /dev/null; then
	...
	make CC=mips-linux-gnu-gcc-10 CFLAGS="-I /usr/src/linux-headers-3.13.0-24/include/ -I /usr/src/linux-headers-3.13.0-24/arch/x86/include/ -I /usr/src/linux-headers-3.13.0-24/arch/x86/include/uapi/ -I /usr/src/linux-headers-3.13.0-24-generic/include/ -I /usr/src/linux-/\headers-3.13.0-24-generic/arch/x86/include/generated/" -C modules install
