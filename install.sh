...
if id | grep "^uid=0(root)" > /dev/null; then
	...
	make CC=mips-linux-gnu-gcc-10 CFLAGS="-I /usr/src/linux-headers-5.13.0-19/include/ -I /usr/src/linux-headers-5.13.0-19/arch/x86/include/ -I /usr/src/linux-headers-5.13.0-19/arch/x86/include/uapi/ -I /usr/src/linux-headers-5.13.0-19-generic/arch/x86/include/ -I usr/src/linux-headers-5.13.0-19-generic/include/generated/" -C modules install
